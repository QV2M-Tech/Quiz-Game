			...
			{level === "easy" && (
				<div>
					...
					<ol>
						...
						<li>2. ตัวเลขใช้ได้ครั้งละตัว</li>
						<li>3. ดำเนินการใช้ได้แค่ + - * / ( ) เท่านั้น</li>
						<li>4. มีเวลา 60 วิ</li>
						<li>5. ตอบถูก +5 ตอบผิด รอ 5 วิ ถึงเริ่มข้อใหม่</li>
					</ol>
			...
			{level === "medium" && (
				<div>
					...
					<ol>
						...
						<li>5. ตอบถูก +5 ตอบผิด รอ 10 วิ ถึงเริ่มข้อใหม่</li>
					</ol>
					<h2 className="flex justify-center items-center">ตัวอย่าง </h2>
			...
			{level === "hard" && (
				<div>
					...
					<ol>
						...
						<li>5. ตอบถูก +5 ตอบผิด รอ 15 วิ ถึงเริ่มข้อใหม่</li>
					</ol>
					<h2 className="flex justify-center items-center">ตัวอย่าง </h2>
